...
import 'onboarding_slide3old_model.dart';
export 'onboarding_slide3old_model.dart';

class OnboardingSlide3oldWidget extends StatefulWidget {
  const OnboardingSlide3oldWidget({Key? key}) : super(key: key);

  @override
  _OnboardingSlide3oldWidgetState createState() =>
      _OnboardingSlide3oldWidgetState();
}

class _OnboardingSlide3oldWidgetState extends State<OnboardingSlide3oldWidget> {
  late OnboardingSlide3oldModel _model;
