...
import 'account_setup3_interests_model.dart';
export 'account_setup3_interests_model.dart';

class AccountSetup3InterestsWidget extends StatefulWidget {
  const AccountSetup3InterestsWidget({Key? key}) : super(key: key);

  @override
  _AccountSetup3InterestsWidgetState createState() =>
      _AccountSetup3InterestsWidgetState();
}

class _AccountSetup3InterestsWidgetState
    extends State<AccountSetup3InterestsWidget> {
  late AccountSetup3InterestsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AccountSetup3InterestsModel());
                                  ...
                                  return InkWell(
                                    ...
                                    onTap: () async {
                                      ...
                                      await currentUserReference!.update({
                                        'user_interests': FieldValue.arrayUnion(
                                            [_model.textController1.text]),
                                      });
                                    },
                                    child: Text(
                                  ...
                                  return InkWell(
                                    ...
                                    onTap: () async {
                                      ...
                                      await currentUserReference!
                                        ...
                                        sign: _model.textController2.text,
                                      ));
                                    },
                                    child: Text(
