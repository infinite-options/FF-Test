...
import 'account_setup_login_model.dart';
export 'account_setup_login_model.dart';

class AccountSetupLoginWidget extends StatefulWidget {
  const AccountSetupLoginWidget({Key? key}) : super(key: key);

  @override
  _AccountSetupLoginWidgetState createState() =>
      _AccountSetupLoginWidgetState();
}

class _AccountSetupLoginWidgetState extends State<AccountSetupLoginWidget> {
  late AccountSetupLoginModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AccountSetupLoginModel());
