...
import 'account_setup_loginold_model.dart';
export 'account_setup_loginold_model.dart';

class AccountSetupLoginoldWidget extends StatefulWidget {
  const AccountSetupLoginoldWidget({Key? key}) : super(key: key);

  @override
  _AccountSetupLoginoldWidgetState createState() =>
      _AccountSetupLoginoldWidgetState();
}

class _AccountSetupLoginoldWidgetState
    extends State<AccountSetupLoginoldWidget> {
  late AccountSetupLoginoldModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AccountSetupLoginoldModel());
