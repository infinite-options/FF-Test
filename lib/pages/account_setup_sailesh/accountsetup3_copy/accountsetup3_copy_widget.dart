...
import 'accountsetup3_copy_model.dart';
export 'accountsetup3_copy_model.dart';

class Accountsetup3CopyWidget extends StatefulWidget {
  const Accountsetup3CopyWidget({Key? key}) : super(key: key);

  @override
  _Accountsetup3CopyWidgetState createState() =>
      _Accountsetup3CopyWidgetState();
}

class _Accountsetup3CopyWidgetState extends State<Accountsetup3CopyWidget> {
  late Accountsetup3CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Accountsetup3CopyModel());
              ...
              child: Column(
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      context.pushNamed('Accountsetup4aCopy');
                    },
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(8.0),
                      child: Image.asset(
